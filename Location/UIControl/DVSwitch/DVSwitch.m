...
{
    if (index < self.strings.count) {
        NSMutableArray * tmpArr = [NSMutableArray arrayWithArray:self.strings];
        tmpArr[index] = str;
        self.strings = tmpArr;
        ((UILabel*)(self.labels[index])).text = str;
        ((UILabel*)(self.onTopLabels[index])).text = str;
    }
}
...
- (void)layoutSubviews
{
    ...
    if (self.sliderImage) {
        ...
        self.sliderView.layer.shadowOpacity = 0.5f;
