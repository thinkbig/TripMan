...
//            NSString * jsonStr = [NSString stringWithContentsOfFile:[[NSBundle mainBundle] pathForResource:@"debugRoute" ofType:@"txt"] encoding:NSUTF8StringEncoding error:nil];
//            NSArray * logArr = [GPSLogItem logArrFromJsonString:jsonStr];
//            
